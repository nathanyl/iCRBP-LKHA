...
def dealwithdata1(protein):
    ...
    dataX = []
    dataY = []
    with open(r'C:\Users\PycharmProjects\CNNfeature\iCircRBP-DHN-iCircRBP-DHN\Datasets/circRNA-RBP/' + protein + '/positive') as f:
        for line in f:
            if '>' not in line:
    ...
    with open(r'C:\Users\PycharmProjects\CNNfeature\iCircRBP-DHN-iCircRBP-DHN\Datasets/circRNA-RBP/' + protein + '/negative') as f:
        for line in f:
            if '>' not in line:
                kmer1 = coden(line.strip(),1,tris1)
                kmer2 = coden(line.strip(),2,tris2)
