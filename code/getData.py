...
def dealwithdata(protein):
    ...
    dataX = []
    dataY = []
    with open('C:/Users/PycharmProjects/CNNfeature/iCircRBP-DHN-iCircRBP-DHN/Datasets\circRNA-RBP/WTAP' + '/positive') as f:
        for line in f:
            if '>' not in line:
                dataX.append(coden(line.strip()))
                dataY.append([0, 1])
    with open('C:/Users/PycharmProjects/CNNfeature/iCircRBP-DHN-iCircRBP-DHN/Datasets\circRNA-RBP/WTAP' +  '/negative') as f:
        for line in f:
            if '>' not in line:
                dataX.append(coden(line.strip()))
                dataY.append([1, 0])
